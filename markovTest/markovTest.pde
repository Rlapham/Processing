...
String text2 = "A very easy and simple test sentence. We will see if this works.";
String[] ritawords;
String[] ritawords2;
...
void setup()
{
  ...
  wordnet = new RiWordNet("/Users/richardlapham/documents/processing//libraries/dict");
  ritawords = text.split(" ");
  ritawords2 = text2.split(" ");
